...
# ngdpbase Plugin System Documentation

ngdpbase implements a JSPWiki-compatible plugin system that allows dynamic content to be embedded in any wiki page.
