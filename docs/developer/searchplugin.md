...
user-keywords: []
slug: searchplugin
lastModified: '2025-10-17T11:50:29.231Z'
author: jim
---
...
```
[{Search query='*' system-category='documentation' max=5}]
```
...
# System Pages
[{Search system-category='system' max=5}]
```
...
### ngdpbase SearchPlugin Enhancements
...
Here are all the plugins available in ngdpbase:
...
- [SearchManager Developer Documentation|https://github.com/jwilleke/ngdpbase/blob/master/docs/managers/SearchManager.md|target='_blank'] - Technical details
- [LunrSearchProvider|https://github.com/jwilleke/ngdpbase/blob/b13bdefb8de264fba9773fbba1e135ea630b5066/src/providers/LunrSearchProvider.js|target='_blank'] - Search provider implementation
- [Plugin System](Plugin-System) - How plugins work in ngdpbase
