...
Understanding YAML Frontmatter in ngdpbase Pages
...
Frontmatter is a block of YAML metadata at the beginning of every wiki page that contains essential information about the page such as its title, category, keywords, and more. It's fundamental to how ngdpbase organizes, stores, and processes page content.
...
**See also:** [Page Storage Guide](/Volumes/hd3/GitHub/ngdpbase/docs/user-guide/Page-Storage.md)
...
ngdpbase uses **[gray-matter](https://github.com/jonschlinkert/gray-matter)** for frontmatter parsing:
