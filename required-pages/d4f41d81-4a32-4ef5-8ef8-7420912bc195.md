...
The **Import Pages** feature (`/admin/import`) allows administrators to import content from external sources into the wiki. It supports zip archives of existing wiki pages, individual files, and multiple source formats.
