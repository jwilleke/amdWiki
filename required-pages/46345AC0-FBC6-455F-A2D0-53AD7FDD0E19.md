...
This guide explains how to integrate the first-run installation system into ngdpbase.
...
```json
{
  "ngdpbase.install.completed": false,
  "ngdpbase.install.require-setup": true,
  "ngdpbase.install.copy-startup-pages": true,
  "ngdpbase.install.create-admin-user": true,
...
```json
{
  ...
  "ngdpbase.base-url": "http://example.com",
  "ngdpbase.session.secret": "[generated]",
  "ngdpbase.install.completed": true,
  "ngdpbase.install.organization.name": "My Organization",
  ...
}
```
...
- Check `ngdpbase.install.completed` in config
