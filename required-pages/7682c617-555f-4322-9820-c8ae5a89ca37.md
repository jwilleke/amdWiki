...
Understanding where and how wiki pages are stored in ngdpbase.

## Overview

ngdpbase uses two directories for page storage, determined by the [system-category] field in page metadata:
