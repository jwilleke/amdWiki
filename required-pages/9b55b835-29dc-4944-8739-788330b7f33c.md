...
lastModified: '2026-02-05T07:56:23.533Z'
author: jim
---
# Overview
...
[system-category] are now configurable via `app-default-config.json` under `amdwiki.systemCategories`.
For details refer to [system-category]
