...
[{$pagename}] in [{$applicationname}] is handled by the [Configuration Manager|https://github.com/jwilleke/ngdpbase/blob/master/docs/managers/ConfigurationManager-Documentation.md|target='_blank']
