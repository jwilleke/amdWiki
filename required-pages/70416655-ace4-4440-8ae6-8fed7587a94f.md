...
Show media that was explicitly associated with a specific page:
...
See [Media] for browsing and managing the media library, [ImagePlugin] for embedding a single image, and [Attachments] for uploading files and images to pages.
