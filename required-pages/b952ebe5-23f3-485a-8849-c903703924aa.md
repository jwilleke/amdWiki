...
**Maintenance Mode** temporarily restricts access to [{$applicationname}] for non-administrator users. While active, regular users see a maintenance notice instead of normal content. Administrators retain full access and can continue working normally.
