...
This page describes the JSON schema that administrators write to define a form used by the [FormPlugin].
...
- For the full plugin invocation syntax, see [FormPlugin].
