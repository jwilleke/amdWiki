...
The **Required Pages Sync** page (`/admin/required-pages`) compares the built-in `required-pages/` source files shipped with ngdpbase against the live wiki pages and allows administrators to synchronize them.
