...
| `[{ConfigAccessor type='siteName'}]` | Live configuration values |
/%
...
Use `[{ConfigAccessor}]` to display configuration values directly on a page. The value is always current — no manual updates needed:

The site name is: [{ConfigAccessor type='siteName'}]
