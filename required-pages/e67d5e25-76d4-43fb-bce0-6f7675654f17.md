...
This page documents ngdpbase's performance characteristics, known bottlenecks, and optimization strategies.
...
**For wikis with 10,000+ pages:** switch to `ElasticsearchSearchProvider` — persistent indexing means no cold rebuild on restart, and each page save is a single-document upsert rather than a full in-memory rebuild. See [Configuration Properties Reference] for the config keys.
