...
[{$applicationname}] supports attaching images, PDFs, and other documents to wiki pages. Attachments are stored centrally and can be embedded or linked from any page.
...
If your wiki has the [Media] feature enabled, you can embed photos from the media library *without* uploading them as attachments. Use the `media://` prefix followed by the original filename:
...
- [ImagePlugin] — full parameter reference for `[{Image}]`
- [AttachPlugin] — full parameter reference for `[{ATTACH}]`
- [Media] — browsing and embedding media library photos
- [Media Management] — administrator guide for the media library
