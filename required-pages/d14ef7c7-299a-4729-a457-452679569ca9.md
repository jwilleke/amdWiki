...
**Media** allows you to browse, search, and embed photos and videos stored on configured folders. Media files are indexed automatically — the [{$applicationname}] reads EXIF, IPTC, and XMP metadata from each file to populate titles, descriptions, keywords, camera details, and GPS coordinates.
...
Use the [MediaPlugin] in any page to embed a live count, list, or thumbnail album of media items.
