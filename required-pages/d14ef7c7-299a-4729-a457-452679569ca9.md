...
## Embedding a Single Photo in a Wiki Page

Use `media://` with [ImagePlugin] or [AttachPlugin] to embed a single media library photo directly in page content — no upload required:
...
## Embedding Albums, Lists, and Counts in Wiki Pages
